...
description: 'Testsigma & Test Management by Testsigma integration also provides unified user management, allowing you to control access for both products from a single interface.'
sidebar:
  order: 11.2
---
...
**With unified access control, you can invite users to Testsigma, Test Management, or both directly from one place.**
...
3. In the **Invite User** dialog:
   ...
   - Select **Add User in Testsigma** if you also want to add the user in Testsigma.
