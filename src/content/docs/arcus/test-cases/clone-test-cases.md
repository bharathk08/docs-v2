...
description: 'Clone test cases to quickly create reusable copies without impacting the original version | Learn how to clone test cases in Test Management by Testsigma'
sidebar:
  order: 3.8
---
