...
description: 'In Test Management by Testsigma, projects come at the top level of the hierarchy that contains test cases, test runs, and test plans | Learn about projects in Test Management'
sidebar:
  order: 2.1
---
