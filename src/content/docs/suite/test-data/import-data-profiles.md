...
description: "In Testsigma, you can also import a test data profile and use it in your tests. This article discusses how to import a test data profile with right file format"
sidebar:
  order: 5.22
---
...
> - Reviewed [Folder Structure for Test Data Profiles](folder-structure-for-test-data-profiles.md).
