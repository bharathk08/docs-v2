...
description: "Explore how MailBoxFunctions streamlines email data retrieval for improved workflow efficiency and clarity. Discover examples and detailed instructions."
sidebar:
  order: 5.44
---
...
> - [Documentation on adding MailBoxFunctions](https://testsigma.com/docs/test-data/types/mailbox/) for accessing and manipulating email content and metadata. 
...
![Test Cases](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_mailboxfunction_1.png)

2. Use **NLP** to create a **new step** in the test case and include a placeholder for **test data**.
![NLP](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_mailboxfunction_2.png)

3. Click on the **test data** placeholder. From the **Test Data Types** dropdown menu, select the **! Data Generator** option.
![Test data types](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_mailboxfunction_3.png)
...
![Data Gen](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_mailboxfunction_4.png)

5. Select **MailboxFunctions** from the **Function Type** dropdown list. 
![select number function type from data generators](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_mailboxfunction_5.png)
