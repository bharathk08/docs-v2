...
description: "Explore the power of various Test Data Types in Testsigma for dynamic and robust test scenarios. Reuse, manage, and optimise your testing with ease."
sidebar:
  order: 5.111
---
...
> - [Documentation on creting test steps](https://testsigma.com/docs/test-cases/create-test-steps/overview/).
...
![Plain Text data type](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/plaintext_testdata.png)
