---
title: "Parameters"
description: "Adding parameters in RESTful API Testing is sending data to a server in order to get a response. Learn how to add Parameters in API Request in Testsigma"
search_keyword: ""
sidebar:
  order: 4.73
---
