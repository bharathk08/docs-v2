...
> - [Documentation on creating test data](https://testsigma.com/docs/test-data/types/overview/).
> - [DOcumentation on creating elements](https://testsigma.com/docs/elements/web-apps/overview/). 
