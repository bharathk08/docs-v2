...
description: "Create web test cases in Testsigma using Atto and AI-powered Copilot. Learn four simple approaches to get started quickly and efficiently."
sidebar:
  order: 4.12
---
...
> - Testsigma Terminal is installed and the Copilot is ready.
> - You have referred to the [Documentation on creating Elements](https://testsigma.com/docs/elements/web-apps/create-manually/).
