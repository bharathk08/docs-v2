...
description: "Create mobile web test cases in Testsigma using Atto and AI-powered Copilot. Learn four simple approaches to get started quickly and efficiently."
sidebar:
  order: 4.14
---
...
> - [Documentation on creating applications](https://testsigma.com/docs/projects/applications/).
> - [Documentation on Testsigma chrome extension installation](https://testsigma.com/docs/test-step-recorder/install-chrome-extension/).
