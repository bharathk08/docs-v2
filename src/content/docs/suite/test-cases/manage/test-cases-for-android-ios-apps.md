...
description: "Manage test cases for Android and iOS apps in Testsigma using Atto and Copilot. Learn how to add steps, record actions, and automate mobile app tests."
sidebar:
  order: 4.22
---
