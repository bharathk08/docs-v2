...
description: "Users can execute MySQL queries within NLPs using the MySQL Addon in Testsigma, enabling seamless integration and efficient database operations."
sidebar:
  order: 24.19
---
