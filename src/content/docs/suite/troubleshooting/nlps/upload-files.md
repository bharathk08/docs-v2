...
description: "This article discusses how to upload files to your test applicationusing the upload NLP. Learn how to upload the file from three sources"
sidebar:
  order: 24.18
---
...
1. Type uplaod and select the ***Upload file test data using the element*** NLP
   ...
   ![Example](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_upload_nlp_1.png)
