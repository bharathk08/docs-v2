...
description: "If Android application is not capturing network logs it may be due to missing proxy certificates or security configurations. Learn how to resolve these errors."
sidebar:
  order: 24.697
---
