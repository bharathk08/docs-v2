...
description: "Learn what to do if you cannot create a new test session due to an unexpected error. Follow these troubleshooting steps to continue your testing sessions."
sidebar:
  order: 24.32
---
