...
description: "This article discusses accessing the Testsigma application by whitelisting the necessary URLs, if you have network restrictions set by your administrator"
sidebar:
  order: 24.23
---
...
- To access the application, ensure that the following domain is whitelisted:
    - ``` *.testsigma.com ```
- To automate secured business applications refer to the [documentation on secured business application support](https://testsigma.com/docs/troubleshooting/setup/secured-business-application-support/). 
