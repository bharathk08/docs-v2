...
description: "When locating an element we need to make sure that the attribute value is unique. This article discusses most common issues caused when using UI identifiers"
sidebar:
  order: 24.53
---
