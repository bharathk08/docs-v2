...
description: "You can configure user-level settings such as updating your profile information, changing your password, & enabling 2FA to add an extra layer of security to your account"
sidebar:
  order: 20.11
---
...
For more details, see [Two-Factor Authentication (2FA) in Testsigma](https://testsigma.com/docs/configuration/security/setup-two-factor-authentication/).
