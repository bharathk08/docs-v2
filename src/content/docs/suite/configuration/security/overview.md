...
description: "Security settings allow you to manage authentication, access control, and account security for the organization | Learn about security features available in Testsigma"
search_keyword: ""
sidebar:
  order: 20.21
---
...
> - You have access to the identity provider required for the security feature you want to configure.
