...
![create function button in AWS Lambda](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/create-function-button-aws-lambda.png)

2. Fill in the basic information for creating a function and click on **Create Function**.
![enter basic information to create function in AWS Lambda](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/basic-information-create-function-aws-lambda.png)
...
3.  Once the function is created, you can scroll down to **Basic Settings** to check the Handler file information along with the basic timeout details.
    ...
    ![handler information for Testsigma integration in AWS Lambda](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/handler-info-testsigma-integration-AWS-Lambda.png)
...
4. You can check the hello.handler file if you scroll up.
    ...
    ![function code for Testsigma integration in AWS Lambda](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/testsigma-integration-function-code-aws-lambda.png)
...
5. The aws-testsigma.sh should contain the below information of the [documentation on getting test plan ID](https://testsigma.com/docs/continuous-integration/get-test-plan-details/) and [API Key](https://testsigma.com/docs/configuration/api-keys/) which you need to trigger:
    ...
    ![aws-testsigma.sh information in AWS Lambda](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/aws-testsigma-sh-aws-lambda.png)


The URL details for the test plan can be taken from **REST API call to start Test Plan** section in Testsigma.
![Get Test Plan ID](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_awslambda_1.png)


6. Click on **TEST** at the top right corner to trigger the Test Plan.
![test Testsigma integration in AWS Lambda](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/test-testsigma-integration-aws-lambda.png)

    ![execution results of Testsigma integration in AWS Lambda](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/testsigma-integration-execution-result-aws-lambda.png)
