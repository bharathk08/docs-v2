...
> - <a href="https://docs.github.com/en/actions/quickstart" rel="nofollow">Documentation on quickstarting with github actions</a>.
> - [Documentation on generating an API keys](https://testsigma.com/docs/configuration/api-keys/).
...
![workflows directory created under folder .github](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/workflows-under-dot-github.png)
...
![testsigma cicd yml file created to trigger the build process](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/testsigma-cicd-yml-file.png)

In this yml file, we have given a build step to trigger/run a Test Plan created in the Testsigma app.

![build step in yml file](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/build-step-in-yml-file.png)
...
![test plan API key and other parameters in Testsigma](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/test-plan-api-key-testsigma.png)
