...
description: "This article discusses in detail step-by-step guide on how to run tests in Copilot in the same window as well as new window in Testsigma application."
search_keyword: ""
sidebar:
  order: 36.3
---
