...
description: "How to manipulate runtime data using Testsigma SDK and create a runtime property for an add-on."
sidebar:
  order: 19.2
---
...
> - [Documentation on creating add-ons](https://testsigma.com/docs/addons/create/).
