...
description: "Install an addon to connect MongoDB and PostgreSQL databases to Testsigma. Learn how to set up a database connection to MongoDB in Testsigma Application."
sidebar:
  order: 18.9
---
...
> - [Documentation on installing add-ons](https://testsigma.com/docs/addons/community-marketplace/) the community addon.
