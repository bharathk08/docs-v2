...
> - You have referred to the [documentation on creating add-ons](https://testsigma.com/docs/addons/create/#creating-an-addon-template).
> - You have an Understanding of the programming language (usually Java) and frameworks.
> - You have referred to the [documentation on how addons work](https://testsigma.com/docs/addons/create/#understanding-the-purpose-of-addons) in Testsigma, including actions and configurations.
