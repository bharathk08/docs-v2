---
title: "Upload a file"
description: "Upload an app or attachment (APK, IPA, or other file) to Testsigma Uploads. Useful for adding files during a CI pipeline run."
sidebar:
  label: "Upload a file"
...
api:
  ...
  bodyFields:
    ...
    - { name: fileContent, desc: "The file to upload (multipart file part)." }
  formData:
    projectId: 24
    name: "APIFileUpload"
  ...
  responseAttributes:
    ...
    - { name: latestVersion, desc: "Object describing the latest version (id, path, fileName, fileSize, status, etc.)." }
