...
description: "Testsigma simplifies Windows Automation with NLPs for the apps built on UWP, WPF, WinForms & Win32 | This article discusses how to create & execute tests for Windows Automation"
sidebar:
  order: 31.1
---
...
> - You have referred to the [documentation on settin up Testsigma Agent](https://testsigma.com/docs/agent/setup-on-windows-mac-linux/).
> - You have an Application Built on UWP/WinForms/WPF/Classic Windows.
...
> - You have enabled **Developer Mode** on Windows Machine.
