...
description: "Learn how to set up authenticator-based authentication in Testsigma using Time-based One-Time Passwords (TOTP) for secure and flexible access."
sidebar:
  order: 25.40
---
