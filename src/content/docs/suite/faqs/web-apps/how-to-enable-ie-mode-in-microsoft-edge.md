...
description: "Learn how to use the ts.ieMode desired capability in Testsigma to launch Microsoft Edge in IE mode and automate tests for legacy IE-dependent web apps."
sidebar:
  order: 25.24
---
