...
description: "Test Case Failures due to link text capture issues? Learn how to fix mismatches between UI and HTML text in automated tests to avoid errors."
search_keyword: ""
sidebar:
  order: 25.17
---
...
> - [Documentation on updating elements](https://testsigma.com/docs/elements/web-apps/create-manually/).
...
- Compare the captured text with what you see in the UI to spot differences. ![view link text capture issue](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_link_issue_1.png)
