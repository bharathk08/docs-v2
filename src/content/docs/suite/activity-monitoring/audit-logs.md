...
1. From the left navigation bar, go to **Settings > Audit Logs**.
   ![Audit Logs](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/Audit_Logs_Navigation.png)
...
2. In the top-right corner, click **Export**.
   ![Export Audit Logs](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/Export_Audit_Logs.png)
...
6. On the **Exports** page, click **Download** next to the generated audit log report.
   ![Download Audit Logs](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/Download_Audit_Logs.png)
