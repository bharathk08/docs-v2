...
description: "Start integrating with test labs to run tests on cloud devices effortlessly. Explore easy steps and prerequisites for successful integration."
sidebar:
  order: 17.41
---
...
> - You have referred to the [documentation on supported test labs in Testsigma](https://testsigma.com/docs/test-plans/supported-test-lab-types/). 
> - You have the necessary information for integration:
