...
description: "SauceLabs integration lets you execute your Testsigma tests on BrowserStack. Learn how to integrate the SauceLabs Test Execution Platform with Testsigma"
sidebar:
  label: "SauceLabs"
  order: 17.44
---
...
> - You have the username and API Key for SauceLabs which can be obtained from your SauceLabs account dashboard.  
> - You have referred to the [documentation on test lab types in Testsigma](https://testsigma.com/docs/test-plans/supported-test-lab-types/)
