...
description: "Learn how to generate custom PDF reports with detailed steps, prerequisites, and preferences for personalized reports in this comprehensive guide."
search_keyword: ""
sidebar:
  order: 14.28
---
...
> - You have referred to the [documentation on generating API keys](https://testsigma.com/docs/reports/runs/filter-custom-reports/) from your Testsigma account.
...
> - An **HTML template** for the PDF report.  <a href="https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/Custom_Report_Template.txt" rel="nofollow">Click here</a> to download the HTML template.
...
2. For **test plan** level reports, use the Run ID shown on the Run Result page (found in the Execution ID or the URL). ![retrieving runid for test plan level](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_custompdf_1.png)
3. For Test Machine, Test Suite, or Test Case level reports:
   ...
   - Expand the **Content** section and copy the required **ID**. ![retrieving result ids](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_custompdf_2.png)
