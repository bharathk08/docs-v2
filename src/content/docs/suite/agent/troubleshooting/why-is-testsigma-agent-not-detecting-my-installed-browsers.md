...
description: "Fix browser detection issues in Testsigma when the Agent fails to locate web drivers like Chrome or Firefox, preventing proper scans and test execution."
sidebar:
  order: 12.96
---
