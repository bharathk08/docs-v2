...
description: "Execute the tests on local agents from another device using the same Testsigma account | Learn how to trigger tests on local devices from different machines"
sidebar:
  order: 12.84
---
...
> - You have referred to the [documentation on installing Testsigma Agent](https://testsigma.com/docs/agent/setup-on-windows-mac-linux/) on the target machine.
> - You have referred to the [documentation on starting the Testsigma Agent](https://testsigma.com/docs/agent/setup-on-windows-mac-linux/#start-the-testsigma-agent-server-as-a-process) on the target machine.
> - You have integrated Testsigma commands to trigger test plans for CI/CD pipelines. 
