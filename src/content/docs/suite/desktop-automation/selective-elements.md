...
description: "Selective Element Recorder lets you capture UI elements one at a time in desktop apps and view them in a tree structure. This article explains how to use it."
sidebar:
  label: "Selective Element Recorder"
  order: 30.3
---
