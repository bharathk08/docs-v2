...
description: "Compare test execution screenshots with original design files in Figma by adding a design file link and configuring visual testing | Learn how to perform visual testing with Figma designs in Testsigma"
sidebar:
  order: 15.2
---
...
> - [Documentation on configuring visual testing](https://testsigma.com/docs/visual-testing/configure-test-steps/).
